...
def task_features(job):
    ...
    for task in tasks:
        ...
        task_parent_indices = [parent_index for parent_index in job.nx_G.predecessors(task.task_index)]
        task_child_indices = [child_index for child_index in job.nx_G.successors(task.task_index)]
        father_indices[task_index] = task_parent_indices
        child_indices[task_index] = task_child_indices
